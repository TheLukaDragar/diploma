...
\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{images/eva_arhitecture_hq.png}
...
The final model checkpoints were utilized to make predictions on the three test sets from the DFGC-VRA dataset.
