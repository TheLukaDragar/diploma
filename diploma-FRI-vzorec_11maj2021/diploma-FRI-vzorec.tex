...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\def\Title{\ttitle}
\def\Author{\tauthor, luka.dragar3@gmail.com}
\def\Subject{\ttitleEn}
...
\pdfinfo{%
    /Title    (\ttitle)
    /Author   (\tauthor, luka.dragar3@gmail.com)
    /Subject  (\ttitleEn)
    /Keywords (\tkeywordsEn)
...
\thispagestyle{empty}\mbox{}{\vskip0.20\textheight}\mbox{}\hfill\begin{minipage}{0.50\textwidth}%
...
\noindent\begin{tabular}{p{0.11\textwidth}|p{.39\textwidth}|p{.39\textwidth}}
...
%tukaj bi jaz dodal še en odstavek v katerem bi opisal sliko 3.3 in se nanjo skliceval. Drugače je ta slika kar v zraku tukaj. Vidim, da se kasneje sklicuješ na to sliko, ampak pravilo je da je slika v tekstu omenjena preden jo prikažeš. Pa vsak slika, ki jo imaš mora biti opisana.
\begin{figure}[h]
\centering
...
%jaz bi sliko \label{fig:eva}dal tukaj
\begin{figure}[H]
\centering
...
\begin{figure}[!htb]
\centering
\includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=1.0\textwidth]{images/badpred3.png}
...
\begin{figure}[!htb]
\centering
\includegraphics[trim={0cm 0cm 0cm 0cm},clip,width=1.0\textwidth]{images/goodpred.png}
