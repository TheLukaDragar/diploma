...
\begin{itemize}
   \item \textbf{Patch Embedding}:
    ...
    \item \textbf{Class Token}: The \texttt{cls\_token} is a special, learnable token that is prepended to the sequence of patch embeddings. During training, it gets updated to capture global information about the entire image, serving as a universal representation that can be used for tasks like classification. 
